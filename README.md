...
| [`require-direct-registration-import`](src/core/require-direct-registration-import.md)         | a template tag whose registering module the file cannot reach through runtime imports                                   |
