...
| [`property-type-matches-declaration`](src/core/property-type-matches-declaration.md)           | a `{type: …}` option that contradicts the field's declared type                                                         |
